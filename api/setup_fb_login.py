...
def setup_facebook_session():
    ...
    print(
        "The cookie will be automatically saved to the 'fb_session' folder for later scraping."
    )
    print("=" * 60)
    ...
    with sync_playwright() as p:
        ...
        print(
            "Waiting for your action... Close the browser once logged in successfully."
        )
